...
protocol ProfileCoordinatingViewControllerDelegate: class {
    
    /// метод, вызываемый при логауте
    func profileCoordinatingViewControllerLogout()
}
...
final class ProfileCoordinatingController: StackViewController {
    ...
    public weak var delegate: ProfileCoordinatingViewControllerDelegate?
...
extension ProfileCoordinatingController: ProfileCardDelegate {
    ...
    func profileCardLogout() {
        delegate?.profileCoordinatingViewControllerLogout()
    }
}
...
extension ProfileCoordinatingController: ZeroViewControllerDelegate {
